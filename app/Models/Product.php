...
class Product extends Model
{
    ...
    protected $filltable = [
        'product_name', 'product_quantity', 'product_sold', 'product_desc', 'product_content', 'product_price','product_image', 
        'cat_id', 'brand_id', 'type_id', 'product_status', 'product_storage', 'product_total_star', 'product_total_review', 'avg_star'	//các cột trong bảng product
    ];
